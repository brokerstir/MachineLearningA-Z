...
dataset = read.csv('train_mod_short.csv')
...
regressor = lm(formula = SalePrice ~ Neighborhood + OverallQual + OverallCond + GrLivArea + FullBath + HalfBath + TotRmsAbvGrd + YrSold,
               data = dataset) 
